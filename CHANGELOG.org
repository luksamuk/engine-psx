...
- Add Amy Rose!  Amy jumps higher than the  cast, has a lower top  speed and has
  a slips down steep slopes more easily than  the rest of the cast. She also has
  a Piko Piko Hammer attack, a Piko Double Jump, and a Piko Spin Attack.
