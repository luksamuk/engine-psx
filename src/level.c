...
void
_render_16(int16_t vx, int16_t vy, int16_t otz,
           uint16_t frame)
{
    // Clipping
    TILECLIP(16);
...
void
_render_128(int16_t vx, int16_t vy, uint16_t frame,
            uint32_t otz)
{
    // Clipping
    TILECLIP(128);
