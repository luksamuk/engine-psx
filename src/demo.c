...
static DemoPlaybackSample _ghz1demo[] = {
    ...
    {.state = 0x4000, .num_frames = 7},
    {.state = 0x4080, .num_frames = 4},
    {.state = 0x0080, .num_frames = 10},
    {.state = 0x0000, .num_frames = 11},
    {.state = 0x0020, .num_frames = 11},
    {.state = 0x0000, .num_frames = 58},
    {.state = 0x0080, .num_frames = 16},
    {.state = 0x0000, .num_frames = 43},
    {.state = 0x4000, .num_frames = 9},
    {.state = 0x0000, .num_frames = 60},
    ...
    {.state = 0x0020, .num_frames = 53},
    {.state = 0x4020, .num_frames = 17},
    {.state = 0x0020, .num_frames = 18},
    {.state = 0x0000, .num_frames = 75},
    {.state = 0x0020, .num_frames = 48},
    {.state = 0x0000, .num_frames = 75},
    {.state = 0x0040, .num_frames = 6},
    {.state = 0x4040, .num_frames = 7},
    {.state = 0x0040, .num_frames = 26},
    {.state = 0x0000, .num_frames = 96},
...
static DemoPlaybackSample _aoz1demo[] = {
    {.state = 0x0000, .num_frames = 64},
    {.state = 0x4080, .num_frames = 20},
    {.state = 0x0080, .num_frames = 17},
    {.state = 0x4080, .num_frames = 3},
    {.state = 0x4000, .num_frames = 14},
    {.state = 0x4020, .num_frames = 30},
    {.state = 0x4000, .num_frames = 35},
    {.state = 0x4020, .num_frames = 4},
    {.state = 0x0020, .num_frames = 6},
    {.state = 0x4020, .num_frames = 9},
    {.state = 0x0020, .num_frames = 190},
    ...
    {.state = 0x0000, .num_frames = 17},
    {.state = 0x4020, .num_frames = 15},
    {.state = 0x0020, .num_frames = 104},
    {.state = 0x0060, .num_frames = 3},
    {.state = 0x0040, .num_frames = 7},
    {.state = 0x0000, .num_frames = 128},
    {.state = 0x0020, .num_frames = 48},
    {.state = 0x4020, .num_frames = 17},
    {.state = 0x0020, .num_frames = 6},
    {.state = 0x0000, .num_frames = 33},
    ...
    {.state = 0x0000, .num_frames = 15},
    {.state = 0x0020, .num_frames = 57},
    {.state = 0x0000, .num_frames = 50},
    {.state = 0x0020, .num_frames = 110},
