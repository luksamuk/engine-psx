...
static DemoPlaybackSample _swz1demo[] = {
    {.state = 0x0000, .num_frames = 95},
    {.state = 0x0020, .num_frames = 338},
    {.state = 0x0000, .num_frames = 37},
...
static DemoPlaybackSample _aoz1demo[] = {
    {.state = 0x0000, .num_frames = 136},
    {.state = 0x4000, .num_frames = 1},
    {.state = 0x4080, .num_frames = 34},
    {.state = 0x0080, .num_frames = 5},
    {.state = 0x0000, .num_frames = 15},
    ...
    {.state = 0x0020, .num_frames = 233},
    {.state = 0x4020, .num_frames = 39},
    {.state = 0x0020, .num_frames = 20},
    {.state = 0x4020, .num_frames = 23},
    {.state = 0x0020, .num_frames = 97},
    {.state = 0x4020, .num_frames = 41},
    {.state = 0x0020, .num_frames = 20},
    {.state = 0x4020, .num_frames = 14},
    {.state = 0x0020, .num_frames = 119},
    {.state = 0x0000, .num_frames = 11},
    {.state = 0x0080, .num_frames = 26},
    {.state = 0x0000, .num_frames = 11},
    {.state = 0x0020, .num_frames = 43},
    ...
    {.state = 0x0000, .num_frames = 77},
    {.state = 0x0020, .num_frames = 151},
    {.state = 0x0000, .num_frames = 0},
};
