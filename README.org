...
* HUGE DISCLAIMER FOR THIS BRANCH!!!

#+html: <big><strong>
This  is an  experimental branch  that  uses background  music created  thorough
Generative AI. I DO NOT ENDORSE the usage of AI for generating art, but I wanted
to  see for  myself if  anything  substantial could  be generated,  and here  we
are. Mind that  right now I think  that this soundtrack is  "soulless" and feels
rather out-of-touch with  the rest of the game,  but I will also let  you be the
judge  of  that, just  for  fun.  This branch  will  probably  never be  merged,
into the base game.
#+html: </strong></big>
